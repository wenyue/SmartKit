...
**Vendored Plugin Skill（插件内置第三方技能）**:
...
**Static MCP Readiness（MCP 静态就绪条件）**:
...
**Daily Project Check Gate（每日项目检查关口）**:
...
**MCP Readiness Profile（MCP 就绪检查配置）**:
