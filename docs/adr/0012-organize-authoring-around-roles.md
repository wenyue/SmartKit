...
only alignment, delegation, validation, review-round management, and handoff. The Controller
contract holds topology changes, brief correction, and user-input handling. Correctness owns
